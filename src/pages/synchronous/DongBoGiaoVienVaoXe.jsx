...
import { Card, Input, Button, Table, Row, Col, message } from "antd";
...
export default function AssignTeacherToVehicle() {
  ...
  // Fetch danh sách giáo viên - gọi khi searchParams thay đổi
  const {
    data: dataTeachers = {},
    isLoading: isLoadingTeachers,
    refetch: refetchTeachers,
  } = useQuery({
    queryKey: ["danhSachGiaoVien", searchParams],
    queryFn: () =>
      DanhSachGiaoVien({
        page: 1,
        limit: 20,
